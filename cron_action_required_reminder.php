...
// (δηλ. απορρίφθηκε το ανεβασμένο αρχείο σύμβασης και περιμένουμε νέο ανέβασμα, ή δεν έχει
// ολοκληρωθεί η διαδικασία). Στέλνει το πολύ 1 υπενθύμιση ανά αίτηση ανά 24ωρο.
//
...
echo date('c') . " — βρέθηκαν " . count($requests) . " αιτήσεις ACTION_REQUIRED προς υπενθύμιση.\n";
